        ...
        <div className="header-content">
          ...
          <nav className="navigation">
            ...
            <ul className="nav-list">
              <Link to="/Home"><li  style={{color: 'white',fontSize: '30px'}}className="nav-item">  home</li></Link>&nbsp;&nbsp;
              <Link to="/Contact"><li style={{color: 'white',fontSize: '30px'}}className="nav-item">  contact</li></Link>
            </ul>
          </nav>
        </div>
      </header>
